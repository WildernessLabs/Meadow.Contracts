...
public class CloudTelemetryItem
{
    ...
    /// <param name="priority">The priority level of the telemetry item. Default is Normal.</param>
    public CloudTelemetryItem(object item, string endpoint, CloudTelemetryPriority priority = CloudTelemetryPriority.Normal)
    {
        Item = item;
        EndPoint = endpoint;
        Priority = priority;
    ...
    /// </summary>
    public CloudTelemetryPriority Priority { get; set; }
    /// <summary>
